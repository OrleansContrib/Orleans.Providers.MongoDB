    ...
    public class ReminderTestGrain2 : Grain, IReminderTestGrain2, IRemindable
    {
        ...
        public async Task<IGrainReminder> StartReminder(string reminderName, TimeSpan? p = null, bool validate = false)
        {
            ...
            if (validate)
                ...
                r = await base.RegisterOrUpdateReminder(reminderName, usePeriod - TimeSpan.FromSeconds(2), usePeriod);
        ...
        {
            return string.Format("{0}{1}{2}", AppDomain.CurrentDomain.SetupInformation.ApplicationBase, filePrefix.Replace("*", "").Replace("/", ""), reminderName);
        }
