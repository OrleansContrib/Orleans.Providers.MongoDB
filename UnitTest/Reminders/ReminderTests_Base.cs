...
namespace UnitTests.TimerTests
{
    ...
    {
        internal static readonly TimeSpan LEEWAY = TimeSpan.FromSeconds(5); // the experiment shouldnt be that long that the sums of leeways exceeds a period
        ...
        {
            ClientConfiguration cfg = ClientConfiguration.LoadFromFile("ClientConfiguration.xml");
        }
