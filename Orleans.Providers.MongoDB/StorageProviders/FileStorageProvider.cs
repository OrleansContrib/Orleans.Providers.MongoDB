namespace Orleans.Providers.MongoDB.StorageProviders
{
    ...
    public class OrleansFileStorage : BaseJSONStorageProvider
    {
        ...
        public override Task Init(string name, IProviderRuntime providerRuntime, IProviderConfiguration config)
        {
            ...
            if (string.IsNullOrWhiteSpace(this.RootDirectory)) throw new ArgumentException("RootDirectory property not set");
            this.DataManager = new GrainStateFileDataManager(this.RootDirectory);
