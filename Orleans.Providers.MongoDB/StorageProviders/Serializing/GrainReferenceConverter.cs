...
namespace Orleans.Providers.MongoDB.StorageProviders.Serializing
{
    public class GrainReferenceConverter : JsonConverter
    {
        ...
        public GrainReferenceConverter(IGrainFactory grainFactory)
        {
            ...
            internalSerializer = JsonSerializer.Create(new JsonSerializerSettings
            {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            var grainRef = internalSerializer.Deserialize(reader, objectType) as IAddressable;
    
            if (grainRef != null)
            {
                // Bind the deserialized grain reference to the runtime.
                grainFactory.BindGrainReference(grainRef);
            }
